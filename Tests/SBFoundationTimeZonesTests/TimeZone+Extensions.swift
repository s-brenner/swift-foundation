import XCTest
@testable import SBFoundationTimeZones
...
final class TimeZoneExtensionsTests: XCTestCase {
    ...
    func testKnownTimeZoneIdentifiersCount() {
        ...
        guard TimeZone.staticTimeZones.count == TimeZone.knownTimeZoneIdentifiers.count
        else {
        ...
        guard TimeZone.staticTimeZoneTests.count == TimeZone.knownTimeZoneIdentifiers.count
        else {
